...
import { applyNumber, changeOperation, displayClear, 
         memoryAdd, memoryRecall, memoryClear } 
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton value={"-"} onClick={() => handleOperation("-")} />
              <CalcButton value={"/"} onClick={() => handleOperation("/")} />
              <CalcButton value={"▄              ▄	Test	▌▒█           ▄▀▒▌"} onClick={() => handleOperation("**")} />
            </div>

            <div className="row ce_button">
              <CalcButton value={"CE"} onClick={() => handleMemoryClear()} />
            </div>
